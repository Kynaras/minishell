...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2020/01/30 12:19:42 by keverett          #+#    #+#             */
/*   Updated: 2020/01/30 12:19:43 by keverett         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void			ft_setenv(t_env_list *original, char *name, char *value,
int write);
...
char			**ft_namecomplete(const char *arg, int arg2, int arg3);
char			*ft_namegen(const char *arg, int arg2);
